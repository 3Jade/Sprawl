...
namespace sprawl
{
	namespace collections
	{
		template<
			...
			typename Accessor1
		>
		class HashMap<ValueType, Accessor1, NullAccessor, NullAccessor>
		{
		public:

			typedef ValueType value_type;
			typedef AccessorGroup<ValueType, Accessor1> mapped_type;
			...
			bool insert(ValueType const& val, typename Accessor1::key_type const& key)
			{
				mapped_type* newItem = (mapped_type*)allocator::alloc();
